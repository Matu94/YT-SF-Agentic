...
CREATE USER IF NOT EXISTS YT_SF_CICD_USER
  DEFAULT_ROLE = YT_SF_PROD_CICD_ROLE
  DEFAULT_WAREHOUSE = YT_SF_CICD_WH
  MUST_CHANGE_PASSWORD = FALSE;

GRANT ROLE YT_SF_PROD_CICD_ROLE TO USER YT_SF_CICD_USER;
GRANT ROLE YT_SF_DEV_CICD_ROLE TO USER YT_SF_CICD_USER;
...
CREATE USER IF NOT EXISTS YT_SF_DBT_USER
  DEFAULT_ROLE = YT_SF_PROD_TRANSFORM_ROLE
  DEFAULT_WAREHOUSE = YT_SF_TRANSFORM_WH
  MUST_CHANGE_PASSWORD = FALSE;

GRANT ROLE YT_SF_PROD_TRANSFORM_ROLE TO USER YT_SF_DBT_USER;
GRANT ROLE YT_SF_DEV_TRANSFORM_ROLE TO USER YT_SF_DBT_USER;

-- 3. Create a user for Python data ingestion process
CREATE USER IF NOT EXISTS YT_SF_LOAD_USER
  DEFAULT_ROLE = YT_SF_PROD_LOAD_ROLE
  DEFAULT_WAREHOUSE = YT_SF_LOAD_WH
  MUST_CHANGE_PASSWORD = FALSE;

GRANT ROLE YT_SF_PROD_LOAD_ROLE TO USER YT_SF_LOAD_USER;
GRANT ROLE YT_SF_DEV_LOAD_ROLE TO USER YT_SF_LOAD_USER;

-- 4. Create a user for Reporting and BI tools
CREATE USER IF NOT EXISTS YT_SF_REPORTING_USER
  DEFAULT_ROLE = YT_SF_PROD_REPORTING_ROLE
  DEFAULT_WAREHOUSE = YT_SF_REPORTING_WH
  MUST_CHANGE_PASSWORD = FALSE;

GRANT ROLE YT_SF_PROD_REPORTING_ROLE TO USER YT_SF_REPORTING_USER;
GRANT ROLE YT_SF_DEV_REPORTING_ROLE TO USER YT_SF_REPORTING_USER;
