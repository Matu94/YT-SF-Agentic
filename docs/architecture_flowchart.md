...
4. **Presentation**: **DigitalOcean App Platform** hosts the **Streamlit** web application. When a user requests data, the embedded **DuckDB** engine reads only the required partitions directly from **AWS S3** and serves the dashboard to the end user.
