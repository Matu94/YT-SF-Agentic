-- 1. Create View for Parsed Landing Channels
-- Resides in LANDING schema, flattens the raw channel JSON data from YOUTUBE_RAW_DATA.

CREATE OR REPLACE VIEW LANDING.V_YOUTUBE_PARSED_CHANNELS AS
SELECT
    EXTRACTED_AT,
