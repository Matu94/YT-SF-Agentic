-- 2. Create View for Parsed Landing Videos
-- Resides in LANDING schema, flattens the raw video list JSON data from YOUTUBE_RAW_DATA.

CREATE OR REPLACE VIEW LANDING.V_YOUTUBE_PARSED_VIDEOS AS
SELECT
    EXTRACTED_AT,
