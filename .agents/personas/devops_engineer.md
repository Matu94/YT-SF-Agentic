...
5.  **Living Documentation & Release Governance:** Strictly adhere to `.agents/rules/05-documentation.md`. Update READMEs immediately when CI/CD or infrastructure logic changes, record changes in `CHANGELOG.md` under `[Unreleased]`, and maintain the active `.release/release_v*.csv` promotion manifest.
